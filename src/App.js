...
function App() {
  ...
  let paginate = (index) => {
    let start = parseInt(per_page) * index;
    let end = start + parseInt(per_page);
  ...
  let next = () => {
    if (currentPage !== data.length / per_page - 1) {
    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-12 mt-3">
          <h3>User Table</h3>
          <hr/>
          <h4>Select the length of table</h4>
          <select
            onChange={(e) => {
        ...
        <div className="col-lg-12">
          ...
          <nav aria-label="Page navigation example">
            <ul class="pagination">
              <li class="page-item">
                {currentPage !== 0 ? (
                  <button onClick={previous} class="page-link">
                    Previous
                  </button>
                ) : null}
              </li>
              {[...Array(data.length / per_page)].map((page, index) => {
                return (
                  <li class="page-item">
                    <button
                      class={`page-link ${
              ...
              <li class="page-item">
                {currentPage !== data.length / per_page - 1 ? (
                  <button
                    disabled={currentPage === data.length / 5 - 1}
                    class="page-link"
                    onClick={next}
                  >
                    Next
